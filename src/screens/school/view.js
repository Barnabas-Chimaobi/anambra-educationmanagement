...
class SchoolView extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (
      nextProps.Biodata.code.toLowerCase() !== this.state.number.toLowerCase()
    ) {
          ...
          >
            ...
            <View style={styles.buttonViewRightLarge}>
              <Button
                ...
                style={styles.button}
                onPress={() => {
                  this.lookupNumber(), CheckConnectivity();
                }}
              >
...
const mapDispatchToProps = (dispatch) => {
  return {
    loadSchoolDataAsync: (code) =>
      dispatch(biodataActions.loadSchoolDataAsync(code)),
