            ...
            >
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                <Text style={styles.labelTextLong}>
                  Are facilities shared with other schools?
                </Text>
                <Switch
                  onValueChange={this.togglesharesFacilities}
              ...
              {this.props.Profile.schoolRecord.sharesFacilities ? (
                ...
                >
                  <Text style={styles.labelTextLong}>
                    How many schools share facilities?
                  </Text>
                  <TextInput
                    keyboardType="numeric"
                    onChangeText={(text) =>
                      this.handleProfileChangeNumverText(
                        "sharedFacilitiesCount",
                        text
                      )
                    }
                    value={`${this.props.Profile.schoolRecord.sharedFacilitiesCount}`}
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                <Text style={styles.labelTextLong}>
                  Is there multi-grade teaching in the school?
                </Text>
                <Switch
                  onValueChange={this.toggleMultigradeTeachers}
                  value={this.props.Profile.schoolRecord.hasMultigradeTeachers}
                />
              </View>
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                <Text style={styles.labelTextLong}>
                  Distance from communities (KM)
                </Text>
                <TextInput
                  keyboardType="numeric"
                  onChangeText={(text) =>
                    this.handleProfileChangeNumverText("distanceFromTown", text)
                  }
                  value={`${this.props.Profile.schoolRecord.distanceFromTown}`}
                  style={styles.textInput}
                />
              </View>
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                <Text style={styles.labelTextLong}>
                  Distance from L.G.A Headquarters (KM)
                </Text>
                <TextInput
                  keyboardType="numeric"
                  onChangeText={(text) =>
                    this.handleProfileChangeNumverText("distanceFromLGA", text)
                  }
                  value={`${this.props.Profile.schoolRecord.distanceFromLGA}`}
                  style={styles.textInput}
                />
              </View>
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                <Text style={styles.labelTextLong}>
                  Is the school mixed or single sex?
                </Text>
                <Picker
                  selectedValue={this.props.Profile.schoolRecord.schoolMixId}
                  onValueChange={(mix) => {
                    this.updateSchoolMix(mix);
                  }}
                  style={styles.picker}
                >
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Switch
                  onValueChange={this.toggleBoarding}
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                <Text style={styles.labelTextLong}>
                  Is there a fence around school ?
                </Text>
                <Switch
                  onValueChange={this.toggleFence}
              ...
              {this.props.Profile.schoolRecord.hasPerimeterFence ? (
                ...
                >
                  <Text style={styles.labelTextLong}>
                    Does Fence Need Repair ?
                  </Text>
                  <Switch
                    onValueChange={this.toggleFenceRepair}
                    value={
                      this.props.Profile.schoolRecord.perimeterFenceNeedsRepair
                    }
                  />
                </View>
              ) : null}
              ...
              {this.props.Profile.schoolRecord.hasSecurityPersonnel ? (
                <View>
                  ...
                  >
                    ...
                    <Picker
                      selectedValue={
                        this.props.Profile.schoolRecord.securityPersonnelTypeId
                      }
                      onValueChange={(sec) => {
                        this.updateSecurity(sec);
                      }}
                      style={styles.picker}
                    >
                  ...
                  >
                    ...
                    <TextInput
                      ...
                      value={`${this.props.Profile.schoolRecord.securityPersonnelCount}`}
                      style={styles.textInput}
                    />
                  </View>
                </View>
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                <Text style={styles.labelTextLong}>
                  Does the school have land encroachment?
                </Text>
                <Switch
                  onValueChange={this.toggleLand}
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                <Text style={styles.labelTextLong}>
                  Does the school have School Based Management Committee (SBMC)?
                </Text>
                <Switch
                  onValueChange={this.toggleSBMC}
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                <Text style={styles.labelTextLong}>
                  Did the school prepare a School Improvement Plan last year?
                </Text>
                <Switch
                  onValueChange={this.toggleSIP}
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Picker
                  selectedValue={this.props.Profile.schoolRecord.parentForumId}
                  onValueChange={(sec) => {
                    this.updateparentForumId(sec);
                  }}
                  style={styles.picker}
                >
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Picker
                  selectedValue={this.props.Profile.schoolRecord.ownershipId}
                  onValueChange={(sec) => {
                    this.updateownershipId(sec);
                  }}
                  style={styles.picker}
                >
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Picker
                  selectedValue={
                    this.props.Profile.schoolRecord.inspectionAuthorityId
                  }
                  onValueChange={(sec) => {
                    this.updateinspectionAuthorityId(sec);
                  }}
                  style={styles.picker}
                >
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    fetchParentForumsList: () =>
      dispatch(biodataActions.fetchParentForumsList()),
    fetchInspectionAuthoritiesList: () =>
      dispatch(biodataActions.fetchInspectionAuthoritiesList()),
    fetchSecurityPersonnelTypesList: () =>
      dispatch(biodataActions.fetchSecurityPersonnelTypesList()),
