...
class SchoolFacility extends Component {
  ...
  setLoadedData = () => {
    if (this.props.Profile.schoolRecord.id > 0) {
      const sClasses = this.props.Profile.schoolRecord.schoolClasses.map(
        (data) => {
          return {
      ...
      const sStream = this.props.Profile.schoolRecord.schoolStreams.map(
        (data) => {
          return {
            id: data.stream.id,
      ...
      const sFacility = this.props.Profile.schoolRecord.schoolFacilities.map(
        (data) => {
          return {
            id: data.facility.id,
      ...
      const sPower = this.props.Profile.schoolRecord.schoolPowerSources.map(
        (data) => {
          return {
      ...
      const sHealth = this.props.Profile.schoolRecord.schoolHealthFacilities.map(
        (data) => {
          return {
      ...
      const sEduLevel = this.props.Profile.schoolRecord.schoolEducationLevels.map(
        (data) => {
          return {
  ...
  onSelectedHealthFacilityItemsChange = (healthFacilityId, healthFacility) => {
    ...
    if (healthFacilityId) {
      schoolHealthFacilities.push({
        id: healthFacilityId,
        name: healthFacility,
      });
      this.setState({ schoolHealthFacilities: schoolHealthFacilities });
      this.props.addSchoolHealthFacilities({
  ...
  onSelectedEduLevelItemsChange = (educationLevelId, educationLevel) => {
    ...
    if (educationLevelId) {
      schoolEducationLevels.push({
        id: educationLevelId,
        name: educationLevel,
      });
      this.setState({ schoolEducationLevels: schoolEducationLevels });
      this.props.addSchoolEducationLevels({
        ...
        <Container>
          ...
          <Content>
            ...
            >
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setEduLevelModalVisible(true);
                  }}
                >
                  <Text
                    style={{
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setClassModalVisible(true);
                  }}
                >
                  <Text
                    style={{
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setFacilityModalVisible(true);
                  }}
                >
                  <Text
                    style={{
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setPowerSourceModalVisible(true);
                  }}
                >
                  <Text
                    style={{
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setHealthFacilityModalVisible(true);
                  }}
                >
                  <Text
                    style={{
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setGrantsModalVisible(true);
                  }}
                >
                  <Text
                    style={{
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Switch
                  onValueChange={(value) =>
                    this.props.addSchoolRecord("hasSportsFacillity", value)
                  }
              ...
              >
                <View
                  style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}
                >
                  <Text style={styles.labelTextLong}>
                    Number teacher textbooks{" "}
                  </Text>
                  <TextInput
                    onChangeText={(text) =>
                      this.props.addSchoolRecord(
                        "teacherTextbooksProvided",
                        text
                      )
                    }
                    value={`${this.props.Profile.schoolRecord.teacherTextbooksProvided}`}
                ...
                >
                  ...
                  <TextInput
                    onChangeText={(text) =>
                      this.props.addSchoolRecord(
                        "studentTextbooksProvided",
                        text
                      )
                    }
                    value={`${this.props.Profile.schoolRecord.studentTextbooksProvided}`}
                    style={styles.textInput}
                  />
                </View>
              </View>
            ...
            >
              <View>
                <MultiSelect
                  data={this.props.studentClasses}
                  onSelectedItem={this.onSelectedClassItemsChange}
                />
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setClassModalVisible(!this.state.ClassModalVisible);
                  }}
                >
            ...
            >
              <View>
                <MultiSelect
                  ...
                  onSelectedItem={this.onSelectedSteamrItemsChange}
                />
            ...
            >
              <View>
                <MultiSelect
                  ...
                  onSelectedItem={this.onSelectedFacilityItemsChange}
                />
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setFacilityModalVisible(
                      !this.state.FacilityModalVisible
                    );
                  }}
                >
                  <Text style={{ alignSelf: "center", fontSize: 20 }}>
            ...
            >
              <View>
                <MultiSelect
                  data={this.props.powerSources}
                  onSelectedItem={this.onSelectedPowerItemsChange}
                />
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setPowerSourceModalVisible(
                      !this.state.PowerModalVisible
                    );
                  }}
                >
                  <Text style={{ alignSelf: "center", fontSize: 20 }}>
            ...
            >
              <View>
                <MultiSelect
                  data={this.props.healthFacilities}
                  onSelectedItem={this.onSelectedHealthFacilityItemsChange}
                />
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setHealthFacilityModalVisible(
                      !this.state.HealthFacilityModalVisible
                    );
                  }}
                >
                  <Text style={{ alignSelf: "center", fontSize: 20 }}>
            ...
            >
              <View>
                <MultiSelect
                  ...
                  onSelectedItem={this.onSelectedGrantItemsChange}
                />
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setGrantsModalVisible(!this.state.GrantModalVisible);
                  }}
                >
                  <Text style={{ alignSelf: "center", fontSize: 20 }}>
                    Confirm Selection
            ...
            >
              <View>
                <MultiSelect
                  data={this.props.educationLevels}
                  onSelectedItem={this.onSelectedEduLevelItemsChange}
                />
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setEduLevelModalVisible(
                      !this.state.EduLevelModalVisible
                    );
                  }}
                >
                  <Text style={{ alignSelf: "center", fontSize: 20 }}>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    savechoolDataAsync: (data) =>
      dispatch(biodataActions.savechoolDataAsync(data)),
    ...
    fetchEducationLevelsList: () =>
      dispatch(biodataActions.fetchEducationLevelsList()),
    fetchHealthFacilityList: () =>
      dispatch(biodataActions.fetchHealthFacilityList()),
    fetchPowerSourcesList: () =>
      dispatch(biodataActions.fetchPowerSourcesList()),
    fetchHealthFacilityList: () =>
      dispatch(biodataActions.fetchHealthFacilityList()),
  };
};
