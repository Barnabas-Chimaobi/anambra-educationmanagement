      ...
      >
        ...
        <View>
          ...
          <Text style={styles.descriptionText}>
            Student, Teacher and School Infromation Base
          </Text>
        </View>
        <View
          style={{
        ...
        >
          ...
          <View style={styles.buttonView}>
            <Button
              large
              block
              style={{ backgroundColor: "rgba(146, 56, 236, 0.35)" }}
              onPress={() => {
                this.props.navigation.navigate("Student"), CheckConnectivity();
              }}
            >
          ...
          <View style={styles.buttonView}>
            <Button
              large
              block
              style={{ backgroundColor: "rgba(56, 96, 236, 0.35)" }}
              onPress={() => {
                this.props.navigation.navigate("Teacher"), CheckConnectivity();
              }}
            >
          ...
          <View style={styles.buttonView}>
            <Button
              large
              block
              style={{ backgroundColor: "rgba(236, 56, 196, 0.35)" }}
              onPress={() => {
                this.props.navigation.navigate("School"), CheckConnectivity();
              }}
            >
