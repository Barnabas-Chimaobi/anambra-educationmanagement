          ...
          <Content>
            ...
            >
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TextInput
                  onChangeText={(text) =>
                    this.handleGuardianChangeText("name", text)
                  }
                  value={this.props.Biodata.guardian.name}
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Text style={styles.Asterix}>*</Text>
                <Picker
                  selectedValue={this.props.Biodata.guardian.stateId}
                  onValueChange={(stateId) => this.updateStateOrigin(stateId)}
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Text style={styles.Asterix}>*</Text>
                <Picker
                  selectedValue={this.props.Biodata.guardian.lgaId}
                  onValueChange={(lga) => this.updateLga(lga)}
                  style={{ height: 35, width: 150, backgroundColor: "#f2f2f2" }}
                >
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Text style={styles.Asterix}>*</Text>
                <Picker
                  selectedValue={this.props.Biodata.guardian.relationshipId}
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TextInput
                  onChangeText={(text) =>
                    this.handleGuardianChangeText("address", text)
                  }
                  value={this.props.Biodata.guardian.address}
                  style={styles.textInput}
                />
              </View>
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    this.handleGuardianChangeText("phone", text)
                  }
                  value={`${this.props.Biodata.guardian.phone}`}
                  style={styles.textInput}
                />
              </View>
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    this.handleGuardianChangeText("email", text)
                  }
                  value={this.props.Biodata.guardian.email}
                  style={styles.textInput}
                />
              </View>
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TextInput
                  onChangeText={(text) =>
                    this.handleGuardianChangeText("anssidNumber", text)
                  }
                  value={this.props.Biodata.guardian.anssidNumber}
                  style={styles.textInput}
                />
              </View>
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TextInput
                  onChangeText={(text) =>
                    this.handleGuardianChangeText("occupation", text)
                  }
                  value={this.props.Biodata.guardian.occupation}
                  style={styles.textInput}
                />
              </View>
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TextInput
                  onChangeText={(text) =>
                    this.handleBioChangeText("school", text)
                  }
                  value={this.props.Biodata.previousEducations[0].school}
                  style={styles.textInput}
                />
              </View>
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TextInput
                  onChangeText={(text) =>
                    this.handleBioChangeText("reasonForLeaving", text)
                  }
                  value={
                    this.props.Biodata.previousEducations[0].reasonForLeaving
                  }
                  style={styles.textInput}
                />
              </View>
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Text style={styles.Asterix}>*</Text>
                <Picker
                  selectedValue={this.props.Biodata.studentRecords[0].schoolId}
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TextInput
                  keyboardType="numeric"
                  onChangeText={(text) =>
                    this.handleSchoolChangeText("distanceFromSchool", text)
                  }
                  value={`${this.props.Biodata.studentRecords[0].distanceFromSchool}`}
                  style={styles.textInput}
                />
              </View>
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Picker
                  selectedValue={
                    this.props.Biodata.studentRecords[0].studentClassId
                  }
                  onValueChange={(Studentclass) => {
                    this.updateClass(Studentclass);
                  }}
                  style={{ height: 35, width: 150, backgroundColor: "#f2f2f2" }}
                >
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Text style={styles.Asterix}>*</Text>
                <Picker
                  selectedValue={this.props.Biodata.studentRecords[0].streamId}
                  onValueChange={(StudentStream) => {
                    this.updateStream(StudentStream);
                  }}
                  style={{ height: 35, width: 150, backgroundColor: "#f2f2f2" }}
                >
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Switch
                  onValueChange={(boarding) => {
                    this.updateBording(boarding);
                  }}
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Picker
                  selectedValue={
                    this.props.Biodata.studentSpecialNeeds[0].specialNeedId
                  }
                  onValueChange={(SpecialNeed) => {
                    this.updateSpecialNeed(SpecialNeed);
                  }}
                  style={{ height: 35, width: 150, backgroundColor: "#f2f2f2" }}
                >
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Picker
                  selectedValue={
                    this.props.Biodata.studentVulnerabilities[0].vulnerabilityId
                  }
                  onValueChange={(StudentStream) => {
                    this.updateVulnerability(StudentStream);
                  }}
                  style={{ height: 35, width: 150, backgroundColor: "#f2f2f2" }}
                >
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TextInput
                  onChangeText={(text) =>
                    this.handleBiodataChangeText("alergy", text)
                  }
                  value={this.props.Biodata.person.alergy}
                  style={styles.textInput}
                />
              </View>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    updateGuardDataField: (field, value) =>
      dispatch(biodataActions.addStudentGuarddata(field, value)),
    addStudentRecdata: (field, value) =>
      dispatch(biodataActions.addStudentRecdata(field, value)),
    addStudentNeedsdata: (field, value) =>
      dispatch(biodataActions.addStudentNeedsdata(field, value)),
    addStudentVulndata: (field, value) =>
      dispatch(biodataActions.addStudentVulndata(field, value)),
    addStudentPrevdata: (field, value) =>
      dispatch(biodataActions.addStudentPrevdata(field, value)),
    saveStudentDataAsync: (data) =>
      dispatch(biodataActions.saveStudentDataAsync(data)),
    ...
    fetchRelationshipsList: () =>
      dispatch(biodataActions.fetchRelationshipsList()),
    ...
    fetchSpecialNeedsList: () =>
      dispatch(biodataActions.fetchSpecialNeedsList()),
    fetchVulnerabilityList: () =>
      dispatch(biodataActions.fetchVulnerabilityList()),
