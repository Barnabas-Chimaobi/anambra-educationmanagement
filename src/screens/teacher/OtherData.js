          ...
          <Content>
            ...
            >
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Picker
                  selectedValue={
                    this.props.Biodata.teacherRecord.teacherQualifications
                      .length > 0
                      ? this.props.Biodata.teacherRecord
                          .teacherQualifications[0].qualificationId
                      : null
                  }
                  onValueChange={(QualificationId) => {
                    this.updateQaulification(QualificationId);
                  }}
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setInstitutionModalVisible(true);
                  }}
                >
                  <Text
                    style={{
                ...
                >
                  <Text style={styles.labelTextCenter}>
                    {this.state.institutionHistories.map((level, key) => {
                      return (
                        <Text key={key} style={styles.displayItems}>
                          {level.institution} - {level.date},{" "}
                        </Text>
                      );
                    })}
                  </Text>
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Picker
                  selectedValue={
                    this.props.Biodata.teacherRecord.teacherSpecialization
                      .length > 0
                      ? this.props.Biodata.teacherRecord
                          .teacherSpecialization[0].subjectAreaId
                      : null
                  }
                  onValueChange={(SubjectArea) => {
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    this.handleIntegerValueChangeText("yearsOfExperience", text)
                  }
                  value={`${this.props.Biodata.teacherRecord.yearsOfExperience}`}
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Text style={styles.Asterix}>*</Text>
                <Picker
                  selectedValue={this.props.Biodata.teacherRecord.schoolId}
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Text style={styles.Asterix}>*</Text>
                <Picker
                  selectedValue={this.props.Biodata.teacherRecord.gradeLevelId}
                  onValueChange={(level) => {
                    this.updateGradeLevel(level);
                  }}
                  style={{ height: 35, width: 150, backgroundColor: "#f2f2f2" }}
                >
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Text style={styles.Asterix}>*</Text>
                <Picker
                  selectedValue={this.props.Biodata.teacherRecord.rankId}
                  onValueChange={(Rank) => {
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TextInput
                  onChangeText={(text) =>
                    this.handleChangeText("postHeld", text)
                  }
                  value={this.props.Biodata.teacherRecord.postHeld}
                  style={styles.textInput}
                />
              </View>
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setPostingModalVisible(true);
                  }}
                >
                  <Text
                    style={{
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Text style={styles.Asterix}>*</Text>
                <Picker
                  selectedValue={this.props.Biodata.teacherRecord.staffTypeId}
                  onValueChange={(TypeOfStaff) => {
                    this.updateStaffType(TypeOfStaff);
                  }}
                  style={{ height: 35, width: 150, backgroundColor: "#f2f2f2" }}
                >
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <Text style={styles.Asterix}>*</Text>
                <Picker
                  selectedValue={this.props.Biodata.teacherRecord.StaffClassId}
                  onValueChange={(ClassOfStaff) => {
                    this.updateStaffClass(ClassOfStaff);
                  }}
                  style={{ height: 35, width: 150, backgroundColor: "#f2f2f2" }}
                >
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setSubjectAreaModalVisible(true);
                  }}
                >
                  <Text
                    style={{
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setStreamModalVisible(true);
                  }}
                >
                  <Text
                    style={{
              ...
              <View style={{ paddingTop: 5, margin: 5, flexDirection: "row" }}>
                ...
                <TextInput
                  keyboardType="numeric"
                  onChangeText={(text) =>
                    this.handleIntegerValueChangeText("trainingsAttended", text)
                  }
                  value={`${this.props.Biodata.teacherRecord.trainingsAttended}`}
                  style={styles.textInput}
                />
              </View>
              ...
              >
                ...
                <View style={styles.buttonView}>
                  <Button
                    ...
                    style={styles.button}
                    onPress={() => {
                      this.submitForm(), CheckConnectivity();
                    }}
                  >
            ...
            >
              <View>
                <MultiSelect
                  data={this.props.subjectAreas}
                  onSelectedItem={this.onSelectedItemsChange}
                />
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setSubjectAreaModalVisible(
                      !this.state.SubjectAreaModalVisible
                    );
                  }}
                >
            ...
            >
              <View style={{ maxWidth: 600 }}>
                <MultiSelect
                  ...
                  onSelectedItem={this.onSelectedStreamItemsChange}
                />
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setStreamModalVisible(!this.state.streamModalVisible);
                  }}
                >
                  <Text style={{ alignSelf: "center", fontSize: 20 }}>
                    Confirm Selection
              ...
              <View>
                <View>
                  ...
                  >
                    ...
                    <TextInput
                      onChangeText={(text) =>
                        this.handleChangeOtherText("InstitutionName", text)
                      }
                ...
                <View>
                  ...
                  {this.props.Biodata.teacherRecord.teacherInstitutions.map(
                    (v, key) => {
                      return (
                        <View key={key}>
                          <View
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setInstitutionModalVisible(
                      !this.state.institutionModalVisible
                    );
                  }}
                >
                  <Text
            ...
            >
              <View>
                ...
                <View>
                  ...
                  {this.props.Biodata.teacherRecord.postingHistories.map(
                    (v, key) => {
                      return (
                        <View
                          style={{
                ...
                <TouchableHighlight
                  ...
                  onPress={() => {
                    this.setPostingModalVisible(
                      !this.state.postingModalVisible
                    );
                  }}
                >
                  <Text
...
const mapDispatchToProps = (dispatch) => {
  return {
    addTeacherBiodata: (field, value) =>
      dispatch(biodataActions.addTeacherBiodata(field, value)),
    addTeacherNokdata: (field, value) =>
      dispatch(biodataActions.addTeacherNokdata(field, value)),
    addTeacherRecorddata: (field, value) =>
      dispatch(biodataActions.addTeacherRecorddata(field, value)),
    addTeacherQualificationdata: (payload) =>
      dispatch(biodataActions.addTeacherQualificationdata(payload)),
    addTeacherSubjectdata: (payload) =>
      dispatch(biodataActions.addTeacherSubjectdata(payload)),
    addTeacherStreamdata: (payload) =>
      dispatch(biodataActions.addTeacherStreamdata(payload)),
    addTeacherSpecialisationdata: (payload) =>
      dispatch(biodataActions.addTeacherSpecialisationdata(payload)),
    addTeacherInstitutiondata: (payload) =>
      dispatch(biodataActions.addTeacherInstitutiondata(payload)),
    addTeacherPostingData: (payload) =>
      dispatch(biodataActions.addTeacherPostingData(payload)),
    saveTeacherDataAsync: (data) =>
      dispatch(biodataActions.saveTeacherDataAsync(data)),
    ...
    fetchStaffClassesList: () =>
      dispatch(biodataActions.fetchStaffClassesList()),
    ...
    fetchQualificationList: () =>
      dispatch(biodataActions.fetchQualificationList()),
  };
};
