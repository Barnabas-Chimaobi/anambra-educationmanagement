...
class MainView extends Component {
    ...
    toggleliveIn = (value) => {
        this.props.addTeacherRecorddata("onPremises", value);
    }
                        ...
                        <Content>
                            ...
                            <Form style={{ width: '75%', marginBottom: 40, alignSelf: 'center' }}>
                                    ...
                                    hasCameraPermission === false ? <Text>No access to camera</Text> :
                                        ...
                                        !isCameraVisible ?
                                            <View style={{ paddingTop: 5, margin: 5, flexDirection: 'row' }}>
                                                <Button block style={styles.button} onPress={() => this.setState({ isCameraVisible: !this.state.isCameraVisible })}>
                                                    <Text>Add Image</Text>
                                                </Button>
                                            </View>
                                            :
                                            <Camera style={{ height: 250, flex: 1 }} type={this.state.type} ref={(ref) => {
                                                this.camera = ref;
                                            }}>
                                                <View
                                                    style={{
                                ...
                                <View style={{ paddingTop: 5, margin: 5, flexDirection: 'row' }}>
                                    ...
                                    <TextInput id="fn" onChangeText={text => this.handleBioChangeText('firstName', text)} value={this.props.Biodata.person.firstName} style={styles.textInput} />
                                </View>

                                <View style={{ paddingTop: 5, margin: 5, flexDirection: 'row' }}>
                                    <Text style={styles.labelText}>Last Name</Text>
                                    <Text style={styles.Asterix}>*</Text>
                                    <TextInput id="ln" onChangeText={text => this.handleBioChangeText('surname', text)} value={this.props.Biodata.person.surname} style={styles.textInput} />
                                </View>
                                ...
                                <View style={{ paddingTop: 5, margin: 5, flexDirection: 'row' }}>
                                    ...
                                    <Switch onValueChange={this.toggleliveIn}
                                        value={this.props.Biodata.teacherRecord.onPremises} />
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        resetFormer: () => dispatch(biodataActions.resetForm())
    }
}
