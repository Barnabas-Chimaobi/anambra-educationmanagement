...
class TeacherBiodata extends Component {
  ...
  checkInputFields = () => {
    ...
    if (!this.props.Biodata.person.phone) {
      ...
      let reg = /^\d+$/;
      if (
        !reg.test(this.props.Biodata.person.phone) ||
        this.props.Biodata.person.phone === ""
      ) {
                ...
                {photo !== null && photo.uri ? (
                  ...
                  >
                    <Image
                      ...
                      source={{
                        uri: `data:image/gif;base64,${this.state.base64URL}`,
                      }}
...
export default connect(mapStateToProps, mapDispatchToProps)(TeacherBiodata);
