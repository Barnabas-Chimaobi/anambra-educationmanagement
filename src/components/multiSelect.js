      ...
      <View onLayout={(evt)=>{this.getNewDimensions(evt)}}>
        {this.props.search && <View style={{ flexDirection: 'row', height: 55 }}>
          <View style={{ marginTop: 15, marginLeft: 15, backgroundColor: 'transparent' }}>
            {/* <Ionicons name="md-search" color={this.props.iconColor} size={25}/> */}
          </View>
          <TextInput
            style={{
            ...
            return(
              ...
              >
                ...
                {/* {
                  ...
                  <Ionicons name={this.props.selectedIconName} color={this.props.iconColor} size={this.props.iconSize} />
                  :
                  <Ionicons name={this.props.unselectedIconName} color={this.props.iconColor} size={this.props.iconSize} />
                } */}
              </TouchableOpacity>
            )
          })}
