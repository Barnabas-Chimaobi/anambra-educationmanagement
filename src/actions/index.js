import {
    ...
    ADD_TEACHER_BIODATA,
    ADD_TEACHER_NOKDATA,
    ADD_TEACHER_RECORD_DATA,
    ADD_TEACHER_QUALIFICATION_DATA,
    ADD_TEACHER_POSTING_DATA,
    FETCH_LGAS,
    FETCH_GENDERS,
    FETCH_LGAS_BY_STATE,
    ADD_STUDENT_GUARDDATA,
    FETCH_RELATIONSHIPS,
    FETCH_SCHOOLS,
    FETCH_STUDENT_CLASSES,
    FETCH_STUDENT_STREAMS,
    FETCH_SPECIAL_NEEDS,
    ADD_STUDENT_RECORD_DATA,
    ADD_STUDENT_PREVIOUS_DATA,
    ADD_STUDENT_NEEDS_DATA,
    ADD_STUDENT_VULNERABILITY_DATA,
    FETCH_GRADE_LEVEL,
    FETCH_SUBJECTS,
    FETCH_STAFF_CLASSES,
    FETCH_STAFF_TYPES,
    ...
    FETCH_QUALIFICATION,
    FETCH_SUBJECT_AREA,
    ADD_TEACHER_SPECIALISATION_DATA,
    ADD_TEACHER_INSTITUTION_DATA,
    ...
    ADD_SCHOOL_STREAMS,
    SAVE_STUDENT_DATA,
    ADD_TEACHER_STREAM_DATA,
    ADD_TEACHER_SUBJECT_DATA,
    SAVE_TEACHER_DATA,
    SAVE_SCHOOL_DATA,
    LOAD_STUDENT_DATA,
    LOAD_TEACHER_DATA,
    ...
    return (dispatch) => {
        ...
        fetch(`${appURL}/Schools`, object)
            ...
            .then((res) => {
                ...
                res.schoolRecord.lastInspection = res.schoolRecord.lastInspection.substring(
                    0,
                    10
                );
