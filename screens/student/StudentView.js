                ...
                <View style={{width: '85%', borderBottomColor: '#333', borderBottomWidth: 1, margin :10, marginLeft: 30}}>
                    ...
                    <Form style={{ width: '75%', marginBottom: 40, alignSelf: 'center' }}>
                        ...
                        <View style={{ paddingTop: 5, margin: 5, flexDirection: 'row' }}>
                            ...
                            <Text style={styles.labelText}>{this.state.data.person.name}</Text>
                        </View>


                        <View style={{ paddingTop: 5, margin: 5, flexDirection: 'row' }}>
                            <Text style={styles.labelText}>Sex</Text>
                            <Text style={styles.labelText}>{this.state.data.person.sex.gender}</Text>
                        </View>


                        <View style={{ paddingTop: 5, margin: 5, flexDirection: 'row' }}>
                            <Text style={styles.labelText}>Date of Birth</Text>
                            <Text style={styles.labelText}>{this.state.data.person.dateOfBirth.toString().substring(0,10)}</Text>
                        </View>


                        <View style={{paddingTop: 5,margin:5, flexDirection:'row' }}>
                                    <Text style={styles.labelText}>State of Origin</Text>
                                    <Text style={styles.labelText}>{this.state.data.person.state.name}</Text>
                                </View>
                                <View style={{paddingTop: 5,margin:5, flexDirection:'row' }}>
                                    <Text style={styles.labelText}>L.G.A</Text>
                                    <Text style={styles.labelText}>{this.state.data.person.lga.name}</Text>
                                </View>


                                <View style={{paddingTop: 5,margin:5, flexDirection:'row' }}>
                                    <Text style={styles.labelText}>Hometown</Text>
                                    <Text style={styles.labelText}>{this.state.data.person.hometown}</Text>
                                </View>

                                <View style={{paddingTop: 5,margin:5, flexDirection:'row' }}>
                                    <Text style={styles.labelText}>Residential Address</Text>
                                    <Text style={styles.labelText}>{this.state.data.person.address}</Text>
                                </View>
                                <View style={{paddingTop: 5,margin:5, flexDirection:'row' }}>
                                ...
                                <View style={{paddingTop: 5,margin:5, flexDirection:'row' }}>
                                    ...
                                    <Text style={styles.labelText}>{this.state.data.person.phone}</Text>
                                </View>
                                ...
                                <View style={{paddingTop: 5,margin:5, flexDirection:'row' }}>
                                    ...
                                    <Text style={styles.labelText}>{this.state.data.person.nextOfKin.name}</Text>
                                </View>

                                <View style={{paddingTop: 5,margin:5, flexDirection:'row' }}>
                                    <Text style={styles.labelText}>Email</Text>
                                    <Text style={styles.labelText}>{this.state.data.person.nextOfKin.email}</Text>
                                </View>


                                <View style={{paddingTop: 5,margin:10}}>
                                   <Button style={styles.button} small primary onPress={() => { this.nextPage() }}>
