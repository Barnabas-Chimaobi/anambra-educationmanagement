...
import { View, Text, StyleSheet, Image, TextInput,Picker, ScrollView, Picker, Switch } from "react-native";
...
const styles = StyleSheet.create({
    ...
    button: { backgroundColor: '#098BD3', color: '#fff', textAlign: 'center', paddingLeft: 15, width: '29%',flex: 1,
